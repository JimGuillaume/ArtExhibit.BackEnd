...
namespace ArtExhibit.BackEnd.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260226144328_ReportEntityAndSampleData")]
    partial class ReportEntityAndSampleData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtExhibit.BackEnd.Domain.Entities.Report", b =>
                {
                    b.HasOne("ArtExhibit.BackEnd.Domain.Entities.Item", "ItemReported")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArtExhibit.BackEnd.Domain.Entities.User", "ReportingUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ItemReported");
